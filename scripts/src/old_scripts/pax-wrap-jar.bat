...
:help
echo pax-wrap-jar -g groupId -a artifactId -v version [-- mvnOpts ...]
goto done
:endopts
...
@echo on
mvn %PAX_PLUGIN%:wrap-jar -DgroupId=%_GROUPID_% -DartifactId=%_ARTIFACTID_% -Dversion=%_VERSION_% %_EXTRA_%
:done
