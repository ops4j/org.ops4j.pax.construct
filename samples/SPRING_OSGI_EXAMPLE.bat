...
call pax-add-repository -i spring-osgi -u http://static.springframework.org/maven2-snapshots
...
call pax-import-bundle -g org.springframework.osgi -a spring-osgi-extender -v 1.0-m3-SNAPSHOT -- -DincludeDefaultScope
call pax-import-bundle -g org.springframework.osgi.samples -a weather-service -v 1.0-m3-SNAPSHOT -- -DincludeDefaultScope
